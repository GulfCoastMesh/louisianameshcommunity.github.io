...
### Heltec Automation
We are in partnership with **Heltec Automation**. They have helped provide hardware and kept lines of communication open to us during development of there products, providing resources to help our community reach its goals. 
...
| :--- | :--- | :--- | :--- |
| **Solar Node P1 (Meshtastic)** | 7.00% | 5% Off Product | `S9ZRMA1X` |
| **XIAO Series Promotion** | 8.00% | 2% Off Product | `0YZSYDIW` |
| **HomeAssistant Campaign** | 10.00% | 5% Off Product | `LTLC85G3` |
| **Universal Program** | 3.00% | $2.00 Off Cart | `K7ABUUV9` |
| **Lite Program** | 3.00% | 5% Off Product | `2T3WPI3B` |


## Donations and Store

*[We use kofi to accept donations and as a storefront for stickers that help support and promote our community. They do not take a percentage of the sale excluding payment processing fees.](https://ko-fi.com/louisianameshcommunity)*